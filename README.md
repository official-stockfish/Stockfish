...
The mods can be used in addition to UCI_Elo and Skill Level settings for human play. Without these settings, StockishNPS plays exactly like the current Stockfish15_dev.
