...
enum Value {
  ...
  KnightValueMg = 821,   KnightValueEg = 874,
  BishopValueMg = 839,   BishopValueEg = 891,
  RookValueMg   = 1273,  RookValueEg   = 1288,
  QueenValueMg  = 2528,  QueenValueEg  = 2565,

  MidgameLimit  = 15579, EndgameLimit  = 3992
};
