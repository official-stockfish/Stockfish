...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Queen
   ...
   { S( -3,-39), S( 6,-18), S(13, -9), S( 0,  0) },
   { S(  4,-23), S( 5, -3), S( 9, 13), S(10, 24) },
   { S(  0,-35), S(14, -6), S(12,  9), S( 5, 21) },
   { S( -4,-38), S(10,-23), S( 6,-12), S( 8, -3) },
   { S(-13,-50), S( 4,-27), S(10,-24), S( 8,-12) },
   { S( -6,-75), S(-2,-52), S( 1,-43), S(-2,-36) }
  },
  { // King
