...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Rook
   { S(-24-3, -2-2), S(-13-3,-6-2), S(-7-3, -3-2), S( 2-3,-2-2) },
   { S(-18+3,-10-3), S(-10+3,-7-3), S(-5+3,  1-3), S( 9+3, 0-3) },
   { S(-21-1, 10-8), S( -7-1,-4-8), S( 3-1,  2-8), S( 7-1,-2-8) },
   { S(-13+6, -5-5), S( -5+6, 2-5), S(-4+6, -8-5), S(-6+6, 8-5) },
   { S(-24+3, -8), S(-12+3, 5), S(-1+3,  4), S( 6+3,-9) },
   { S(-24-4,  3+1), S( -4-4,-2+1), S( 4-4,-10+1), S(10-4, 7+1) },
   { S( -8,  1-2), S(  6, 2-2), S(10, 17-2), S(12,-8-2) },
   { S(-22-1, 12-2), S(-24-1,-6-2), S(-6-1, 13-2), S( 4-1, 7-2) }
  },
  { // Queen
