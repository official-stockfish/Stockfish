...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Bishop
   { S(-54,-58), S(-13,-31), S(-25,-37), S(-34,-19) },
   { S(-20,-34), S( 10, -9), S( 12,-14), S(  1,  4) },
   { S( -9,-23), S( 27,  0), S( 11, -3), S( 11, 16) },
   { S(-11,-26), S( 28, -3), S( 21, -5), S( 32, 16) },
   { S(-11,-26), S( 27, -4), S( 16, -7), S( 31, 14) },
   { S(-17,-24), S( 16, -2), S(  2,  0), S(  2, 13) },
   { S(-23,-34), S(  7,-10), S(  6,-12), S( -2,  6) },
   { S(-45,-55), S(-11,-32), S(-19,-36), S(-29,-17) }
  },
  { // Rook
