...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Pawn
   ...
   { S( -2,-12), S(  1,  0), S( 13,  3), S( 17,  6) },
   { S(-21, -4), S( -6, -3), S( 24,  0), S( 23, -5) },
   { S(-12,  1), S(-11,  3), S( 15,-10), S( 26, -3) },
   { S( -1, 13), S( -7,  8), S( -5,  1), S(  6,-10) },
   { S(-11, 20), S(-15,  8), S(  3, 10), S(  1, 17) },
   { S( -9,  5), S( 13, -6), S( -8, 14), S(-10, 21) }
  },
  { // Knight
