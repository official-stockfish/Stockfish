...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2] = {
  ...
  { // Rook
   { S(-24-7, -2-7), S(-13-7,-6-7), S(-7-7, -3-7), S( 2-7,-2-7) },
   { S(-18-3,-10-2), S(-10-3,-7-2), S(-5-3,  1-2), S( 9-3, 0-2) },
   { S(-21-4, 10-4), S( -7-4,-4-4), S( 3-4,  2-4), S( 7-4,-2-4) },
   { S(-13, -5-1), S( -5, 2-1), S(-4, -8-1), S(-6, 8-1) },
   { S(-24-3, -8+3), S(-12-3, 5+3), S(-1-3,  4+3), S( 6-3,-9+3) },
   { S(-24+2,  3+3), S( -4+2,-2+3), S( 4+2,-10+3), S(10+2, 7+3) },
   { S( -8+6,  1+3), S(  6+6, 2+3), S(10+6, 17+3), S(12+6,-8+3) },
   { S(-22+5, 12+6), S(-24+5,-6+6), S(-6+5, 13+6), S( 4+5, 7+6) }
  },
  { // Queen
