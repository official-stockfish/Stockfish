...
namespace {
  ...
  int nw[11][2][11] = 
  {
{{-17,-14,-6,8,14,5,-7,3,-4,-10,-4},{-5,-5,0,-5,-10,3,-7,6,8,3,-4}},
{{-10,2,-3,3,7,-4,10,-8,-5,-1,-13},{8,11,2,6,-4,-2,4,4,9,-6,-8}},
{{-20,10,-2,-4,-2,-4,-14,-6,1,1,0},{1,2,4,-1,-9,-6,-8,1,-10,6,5}},
{{-15,-4,-16,-1,-6,-11,-2,-14,0,2,-1},{1,0,7,-5,1,-3,0,-2,3,1,4}},
{{-6,-8,-15,2,-8,-15,-13,-11,4,-10,-3},{13,10,0,-9,7,6,1,3,8,9,7}},
{{2,-8,5,-28,2,-5,-2,4,-4,-8,-9},{-7,16,-12,-1,-14,3,-11,3,-2,8,3}},
{{-11,-7,-10,-7,-2,-2,8,9,-6,-2,-1},{11,9,-8,1,-2,2,9,11,14,14,0}},
{{-3,-5,-7,-4,7,-8,-6,-7,1,-11,-9},{4,15,-5,1,1,3,3,5,12,12,-2}},
{{-12,-3,2,-1,9,-11,-4,9,-6,-4,1},{-1,5,2,-5,4,3,11,-9,15,23,15}},
{{-6,2,-4,-1,-6,-10,16,-3,-2,5,-1},{-6,-5,-4,3,7,9,-1,8,4,3,2}},
{{-1,-4,2,-3,-15,-15,14,-2,-18,1,-15},{-1,10,-1,6,-6,4,-7,-13,-3,-1,-1}}
  };
  int nbw[2][11] =
  {
...
void Thread::search() {
         ...
         && !(Limits.depth && mainThread && rootDepth > Limits.depth))
  {
          ...
          && !mainThread->stopOnPonderhit)
      {
          ...
          int ft[11]={rootPos.count<PAWN>(WHITE),rootPos.count<ROOK>(WHITE),rootPos.count<KNIGHT>(WHITE),rootPos.count<BISHOP>(WHITE),rootPos.count<QUEEN>(WHITE),
                      ...
                      rootPos.rule50_count()};
          // Matrix multiplication (layers)
          for (size_t m = 0; m < 2; ++m)
          {
              int temp[11] = {0};
              for (size_t i = 0; i < 11; ++i)
                  temp[i]= std::max(0, std::inner_product(ft, ft+11, nw[i][m], 0) + nbw[m][i]); // ReLU activation function
