...
#ifdef Add_Features
void on_book_file(const Option& o) {
    polybook.init(o);
}
void on_best_book_move(const Option& o) {
    polybook.set_best_book_move(o);
}
void on_book_depth(const Option& o) {
    polybook.set_book_depth(o);
}
#endif
...
void init(OptionsMap& o) {
	...
	o["Levels"]			        << Option("var None var World Champion var Super GM "
										  "var Deep Thought var Cray Blitz var Grandmaster "
										  "var Int'l Master var Master var Expert var Class A "
										  "var Class B var Boris var Class C var Challenger 7 "
										  "var Class D var Novice", "None");
