...
bool Position::see_ge(Move m, Value threshold) const {
  ...
  while (true)
  {
      ...
      // Don't allow pinned pieces to attack (except the king) as long all
      ...
      // win. The only thing to be carfeul about it is that we should revert
