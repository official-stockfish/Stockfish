...
namespace Stockfish
{
    ...
    void MovePicker::score()
    {
        ...
        for (auto &m : *this)
            ...
            {
                if (pos.capture(m))
                    m.value = PieceValue[MG][pos.piece_on(to_sq(m))] - Value(type_of(pos.moved_piece(m))) + (1 << 28);
                else
