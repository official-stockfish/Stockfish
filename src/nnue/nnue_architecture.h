...
// Number of input feature dimensions after conversion
    ...
    struct Network {
        ...
        get_hash_value() {
            ...
            hashValue = decltype(fc_0)
            ::get_hash_value(hashValue);
            hashValue = decltype(ac_0)
            ::get_hash_value(hashValue);
            hashValue = decltype(fc_1)
            ::get_hash_value(hashValue);
            hashValue = decltype(ac_1)
            ::get_hash_value(hashValue);
            hashValue = decltype(fc_2)
            ::get_hash_value(hashValue);
        ...
        std::int32_t propagate(const TransformedFeatureType *transformedFeatures) {
            ...
            std::memcpy(buffer.ac_sqr_0_out + FC_0_OUTPUTS, buffer.ac_0_out, FC_0_OUTPUTS * sizeof(decltype(ac_0)
            ::OutputType));
