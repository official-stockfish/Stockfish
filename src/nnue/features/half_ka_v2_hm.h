...
#undef B
    ...
    static IndexType make_index(Color, Square s, Piece pc, Square ksq);
    ...
    static void
    append_changed_indices(Color perspective, Square ksq, const DirtyPiece& dp, IndexList& removed, IndexList& added);
