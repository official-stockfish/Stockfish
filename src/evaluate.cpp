...
namespace {
  ...
  const Score MobilityBonus[][32] = {
    {}, {},
    { S(-65,-51), S(-45,-27), S(-5,-15), S( 3,  4), S( 6,  7), S(33, 22), // Knights
      S( 34, 23), S( 47, 37), S(52, 40) },
    { S(-54,-50), S(-30,-23), S( 2, -3), S(24, 21), S(38, 33), S(56, 52), // Bishops
      S( 56, 54), S( 67, 59), S(72, 64), S(75, 66), S(80, 69), S(87, 73),
      S( 87, 77), S( 87, 78) },
    { S(-52,-64), S(-28,  1), S( 1,  3), S( 1, 14), S( 3, 23), S( 6, 59), // Rooks
      S( 12, 66), S( 21, 82), S(30, 88), S(30,110), S(30,111), S(31,113),
      S( 34,116), S( 36,128), S(44,128) },
    { S(-34,-41), S(-25,-23), S(-9, -7), S(-1,  3), S( 0,  9), S( 8, 12), // Queens
      S( 16, 30), S( 26, 43), S(26, 38), S(26, 38), S(15, 38), S(20, 40),
      S( 21, 40), S( 22, 40), S(23, 40), S(26, 41), S(26, 41), S(26, 41),
