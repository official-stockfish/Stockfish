...
#define stringify(x) stringify2(x)
    ...
    namespace {
        ...
        constexpr Value
        LazyThreshold1 = Value(3631);
        constexpr Value
        LazyThreshold2 = Value(2084);
        constexpr Value
        SpaceThreshold = Value(11551);
