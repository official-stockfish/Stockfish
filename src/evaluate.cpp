...
std::string Eval::trace(Position& pos, const Eval::NNUE::Networks& networks) {
    ...
    ss << "(Small net) NNUE evaluation        " << 0.01 * UCIEngine::to_cp(vSmall, pos) << " (white side)\n";
    ...
    ss << "(Big net) NNUE evaluation          " << 0.01 * UCIEngine::to_cp(vBig, pos) << " (white side)\n";
    ...
    ss << "Final evaluation " << "(using " << (use_smallnet(pos) && !useBig ? "small net) " : "big net)   ");
