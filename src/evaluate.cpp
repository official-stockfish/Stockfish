...
namespace {
  ...
  // evaluate_unstoppable_pawns() scores the most advanced among the passed pawns.
  // In case both players have no pieces but pawns, this is somewhat related to
  // the possibility that pawns are unstoppable.
