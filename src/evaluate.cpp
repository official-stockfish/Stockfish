...
#undef S
  ...
  Score Evaluation<T>::space() const {
    ...
    // Compute space score based on number of safe squares
    // and number of our pieces
  ...
  Value Evaluation<T>::winnable(Score score) const {
    ...
    if (sf == SCALE_FACTOR_NORMAL)
    {
        ...
        // In every other case use scale factor
        // based on number of pawns of the strong side
        // reduced if pawns are on a single flank
        else
