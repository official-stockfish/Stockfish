...
namespace {
  ...
  // Outpost[knight/bishop][supported by pawn] contains bonuses for minor pieces
  // if they can reach an outpost square, bigger if that square is 
  // supported by a pawn. 
  // If the minor piece occupies an outpost square, score is doubled.
