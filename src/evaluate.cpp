...
namespace Eval {
  ...
  void init() {
    ...
    const double MaxSlope = 8.6;
    const double Peak = 1280;
    double t = 0.0;

    for (int i = 1; i < 400; ++i)
    {
        t = std::min(Peak, std::min(0.026 * i * i, t + MaxSlope));
